...
in {
  config.programs.ghostty = lib.mkIf cfg.enable {
    ...
    settings.keybind = [
      ...
      "vim/ctrl+w>ctrl+v=new_split:right"
      "vim/ctrl+w>ctrl+s=new_split:down"
      "vim/ctrl+w>ctrl+o=toggle_split_zoom"
      "vim/ctrl+h=goto_split:left"
      "vim/ctrl+j=goto_split:down"
      "vim/ctrl+k=goto_split:up"
      "vim/ctrl+l=goto_split:right"
      "vim/ctrl+w>h=goto_split:left"
      "vim/ctrl+w>j=goto_split:down"
      "vim/ctrl+w>k=goto_split:up"
      "vim/ctrl+w>l=goto_split:right"
      "vim/ctrl+w>ctrl+h=goto_split:left"
      "vim/ctrl+w>ctrl+j=goto_split:down"
      "vim/ctrl+w>ctrl+k=goto_split:up"
      "vim/ctrl+w>ctrl+l=goto_split:right"
      # Resize
      ...
      # Tab
      "vim/ctrl+t=new_tab"
      "performable:vim/g>t=next_tab"
      "performable:vim/g>shift+t=previous_tab"
      "performable:vim/1>g>t=goto_tab:1"
      "performable:vim/2>g>t=goto_tab:2"
      "performable:vim/3>g>t=goto_tab:3"
      "performable:vim/4>g>t=goto_tab:4"
      "performable:vim/5>g>t=goto_tab:5"
      "performable:vim/6>g>t=goto_tab:6"
      "performable:vim/7>g>t=goto_tab:7"
      "performable:vim/8>g>t=goto_tab:8"
      "performable:vim/9>g>t=goto_tab:9"
      "performable:vim/0>g>t=last_tab"
      # Scratchpad
