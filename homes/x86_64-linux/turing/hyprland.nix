{
  ...
  gamingWindowRules = builtins.concatLists (
    map (pattern: [
      "workspace 5, match:initial_class ${pattern}"
      "workspace 5, match:initial_title ${pattern}"
    ...
    settings = {
      ...
      windowrule = lib.mkAfter (
        [
          ...
          # Steam
          "workspace 5 silent, match:initial_class ^steam$, match:initial_title negative:^Steam Input On-screen Keyboard$"
